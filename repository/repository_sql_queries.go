...
INSERT INTO users (email, password, type, created) values
                                                          ...
                                                          ('vt74@mail.ru', '123', 1, '2020-10-03T14:54:00+00:00'),
...
INSERT INTO masters (user_id, username, fullname, theme, description, qualification, education_format, avg_price) values
                                        (1, 'spiro', 'Сергей Спиридонов', 11, 'Привет, я архитекор из Челябинска, и готов обучить тебя дизайну интерьера! Пиши мне, и мы выберем место и время проведения занятий.', 2, 3, 0),
                                        (2, 'tatyanav', 'Велитченко Татьяна', 2, 'Я преподаватель игры на классической гитаре. Я помогу тебе научиться исполнять любимые песни, и это только начало! ', 2, 1, 0),
